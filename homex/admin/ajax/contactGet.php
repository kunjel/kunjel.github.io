...
// *************************************************************************
	...
	$orders = mysql_qw('SELECT * FROM ' . DB_PREFIX."contacts". ' WHERE cid=?', $_GET['cid']) or die("dont get users");
...
?>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top: 5px;">
		...
		<tr>
			...
			<td class="bl lh al level1" style="width: 150px;"><?=$l['MessageDateSent']?></td>
		...
		<tr>
			...
			<td class="bl lh level1"><?=$l['FirstName']?>, <?=$l['LastName']?></td>
		...
		<tr>
			...
			<td class="bl lh al level1"><?=$l['Subject']?></td>
		...
		<tr>
			...
			<td class="bl lh level1"><?=$l['Message']?></td>
		...
		<tr>
			...
			<td class="bl lh al level1">
				...
				<div id="cst">
					...
					<?=nl2br($us[0]['status'])?> <a href="javascript:showTextBox()" style="font-size: 11px; color: Blue;"><?=$l['Change']?></a>
                ...
                <div id="box" style="display: none; margin-bottom: 5px; margin-top: 3px;">
                	...
                	<div style="padding-top: 5px;">
                		...
                		<input type="submit" name="updateContact" value="<?=$l['Save']?>" />
