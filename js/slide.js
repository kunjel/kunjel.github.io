...
function enableEmailLink(){this.enableEmailLink=false;}
function disableEmailLink(){this.enableEmailLink=false;}
function enablePhotoLink(){this.isEnablePhotoLink=false;}
